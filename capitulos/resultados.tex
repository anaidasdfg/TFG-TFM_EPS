...
\par Finalmente, los parámetros utilizados en este método para cada caso se presentan en la tabla (), donde se pueden ver: la parcela utilizada para el periodo de test del modelo; siendo el resto de parcelas utilizadas en el entrenamiento, y el número de árboles óptimo para \gls{rfr}. 
