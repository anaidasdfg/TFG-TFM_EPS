...
\captionof{figure}{Relación de la salida predicha y la verdad de tierra del modelo para estimación de \gls{bbch}.\label{fig:rel_b}}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=0.955\linewidth]{archivos/tfg/Mean/TEST_PARC_RECTA_H}
\captionof{figure}{Relación de la salida predicha y la verdad de tierra del modelo para estimación de la altura. \label{fig:rel_h}}
\end{figure}
...
\captionof{figure}{Ejemplo de salida \gls{pdf} normalizada del modelo para estimación de \gls{bbch}.\label{fig:p_pdf_b}}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=0.85\linewidth]{archivos/tfg/Pixel/H_PDF}
\captionof{figure}{Ejemplo de salida \gls{pdf} normalizada del modelo para estimación de la altura. \label{fig:p_pdf_h}}
\end{figure}
...
\captionof{figure}{Comparación de la salida predicha y la verdad de tierra del modelo para estimación de \gls{bbch}.\label{fig:p_comp_b}}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=0.95\linewidth]{archivos/tfg/Pixel/H_COMPARACION_BIEN}
\captionof{figure}{Comparación de la salida predicha y la verdad de tierra del modelo para estimación de la altura. \label{fig:p_comp_h}}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.955\linewidth]{archivos/tfg/Pixel/H_RELACION_BIEN}
