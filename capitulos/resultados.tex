...
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{archivos/tfg/Mean/TEST_PARC_RECTA_bh}
...
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{archivos/tfg/Mean/TEST_PARC_RECTA_bh_H}
...
\begin{subfigure}{.6\textwidth}
  ...
  \caption{Comparación de la salida predicha y la verdad de tierra del modelo para estimación de la altura. \label{fig:p_comp_h}}
\end{subfigure}
\begin{subfigure}{.6\textwidth}
  \centering
